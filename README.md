...
Any application can be utilized to generate a tasks file for Krampus to use. Examples of task lists generated by Justice Engine can be found in the [docs](/docs/).
